...
//fetch ehtereum contract "FROM OUR OWN MADE ETHEREUM CONTRACT"
...
export const TransactionProvider = ({ children }) => {
    ...
    const connectWallet = async () => {
        try {
            if(!ethereum) return alert('Please insatll meatamask')
    ...
    const sendTransaction = async () => {
        try {
            ...
            throw new Error("No ethereum object from 104")
        }
    }
