...
const Welcome = () => {
    ...
    return (
        <div className='flex w-full justify-center items-center'>
            <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 my-7 px-4">
                <div className="flex flex-1 justify-start flex-col mf:mr-10">
                    <h1 className='text-3xl sm:text-5xl text-gradient py-1 text-white'>
                        Send Crypto <br/> across the world
                    </h1>
                    <p className='text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base'>
                        Explore the crypto world. Buy and sell cryptocurremcies on Krypt.
                    </p>
                    { 
                    !currentAccount 
                     ?(
                     ...
                     : <h1 className='text-white text-xl mt-4 font-bold'>Connected to Metamask</h1>
                    }
